...
const i18n: Record<LangKey, { label: string; flag: string; hero_tag: string; hero_h1: string; hero_h1_span: string; hero_p: string; read_art: string; min_read: string; footer_text: string; footer_rights: string }> = {
  ...
  hi: { label:"हिं", flag:"🇮🇳", hero_tag:"डेवलपर इनसाइट्स", hero_h1:"MERN Stack Developer", hero_h1_span:"कराची में", hero_p:"React, Next.js, MERN Stack, Shopify, SEO और Freelancing पर 15 गहरे लेख — 40+ असली प्रोजेक्ट्स के बाद लिखे गए।", read_art:"लेख पढ़ें", min_read:"मिनट", footer_text:"पाकिस्तान के पेशेवर वेब डेवलपर", footer_rights:"सर्वाधिकार सुरक्षित" },
  zh: { label:"中文", flag:"🇨🇳", hero_tag:"开发者见解", hero_h1:"卡拉奇MERN", hero_h1_span:"全栈开发者", hero_p:"关于 React、Next.js、MERN Stack、Shopify、SEO 和自由职业的 15 篇深度文章 — 来自 40 多个真实项目的经验。", read_art:"阅读文章", min_read:"分钟", footer_text:"巴基斯坦专业网络开发者", footer_rights:"版权所有" },
  ja: { label:"日本", flag:"🇯🇵", hero_tag:"開発者インサイト", hero_h1:"カラチのMERN", hero_h1_span:"スタック開発者", hero_p:"React、Next.js、MERNスタック、Shopify、SEO、フリーランスに関する15本の深掘り記事 — 40以上の実際のプロジェクトから。", read_art:"記事を読む", min_read:"分", footer_text:"パキスタンのプロWebデベロッパー", footer_rights:"全著作権所有" },
}
