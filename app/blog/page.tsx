...
const i18n: Record<LangKey, { label: string; flag: string; hero_tag: string; hero_h1: string; hero_h1_span: string; hero_p: string; read_art: string; min_read: string; footer_text: string; footer_rights: string }> = {
  en: { label:"EN", flag:"🇺🇸", hero_tag:"Developer Insights", hero_h1:"MERN Stack Developer", hero_h1_span:"in Karachi", hero_p:"20 deep-dives into React, Next.js, MERN Stack, Shopify, SEO, Freelancing & Performance — written from 40+ real projects across Pakistan and beyond.", read_art:"Read Article", min_read:"min read", footer_text:"Professional Web Developer Pakistan", footer_rights:"All rights reserved" },
  ur: { label:"اردو", flag:"🇵🇰", hero_tag:"ڈویلپر انسائٹس", hero_h1:"کراچی میں ویب", hero_h1_span:"ڈویلپر", hero_p:"ری ایکٹ، نیکسٹ جے ایس، ایم ای آر این اسٹیک، شوپائی فائی، ایس ای او اور فری لانسنگ پر 20 گہرے مضامین — 40+ حقیقی پراجیکٹس سے لکھے گئے۔", read_art:"مضمون پڑھیں", min_read:"منٹ", footer_text:"پاکستان کا پیشہ ور ویب ڈویلپر", footer_rights:"تمام حقوق محفوظ ہیں" },
  ro: { label:"Roman", flag:"🇵🇰", hero_tag:"Developer Insights", hero_h1:"MERN Stack Developer", hero_h1_span:"Karachi Mein", hero_p:"React, Next.js, MERN Stack, Shopify, SEO aur Freelancing pe 20 gehri articles — 40+ real projects ke baad likhi gayi hain.", read_art:"Article Parho", min_read:"minute", footer_text:"Pakistan ka Professional Web Developer", footer_rights:"Tamam huquq mahfooz hain" },
  hi: { label:"हिं", flag:"🇮🇳", hero_tag:"डेवलपर इनसाइट्स", hero_h1:"MERN Stack Developer", hero_h1_span:"कराची में", hero_p:"React, Next.js, MERN Stack, Shopify, SEO और Freelancing पर 20 गहरे लेख — 40+ असली प्रोजेक्ट्स के बाद लिखे गए।", read_art:"लेख पढ़ें", min_read:"मिनट", footer_text:"पाकिस्तान के पेशेवर वेब डेवलपर", footer_rights:"सर्वाधिकार सुरक्षित" },
  zh: { label:"中文", flag:"🇨🇳", hero_tag:"开发者见解", hero_h1:"卡拉奇MERN", hero_h1_span:"全栈开发者", hero_p:"关于 React、Next.js、MERN Stack、Shopify、SEO 和自由职业的 20 篇深度文章 — 来自 40 多个真实项目的经验。", read_art:"阅读文章", min_read:"分钟", footer_text:"巴基斯坦专业网络开发者", footer_rights:"版权所有" },
  ja: { label:"日本", flag:"🇯🇵", hero_tag:"開発者インサイト", hero_h1:"カラチのMERN", hero_h1_span:"スタック開発者", hero_p:"React、Next.js、MERNスタック、Shopify、SEO、フリーランスに関する20本の深掘り記事 — 40以上の実際のプロジェクトから。", read_art:"記事を読む", min_read:"分", footer_text:"パキスタンのプロWebデベロッパー", footer_rights:"全著作権所有" },
}
          ...
          {posts.map((post, index) => (
            ...
            >
              ...
              <div className="card-img-wrap">
                <img
                  src={post.img || "https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=1200&auto=format&fit=crop"}
                  alt={post.title}
